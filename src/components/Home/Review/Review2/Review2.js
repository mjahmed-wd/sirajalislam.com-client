  ...
  return (
    ...
    >
      <div className="overlay-black pt-5 pb-5">
        <div className={`${language==="ar"?"arabic":""} container text-center pt-5 pb-5`}>
          <p  style={{ color: "white", fontSize: "20px", margin:"50px" }}>
            ...
            />
           {language==="en"?` Siraj Al Islam, recognised as one of the best lawyer in Saudi Arabia`:`حاز سراج الاسلام على جائزة أفضل
محام في المملكة العربية السعودية`}
          ...
          <p style={{ color: "white", fontSize: "20px" }}>
            <Icon
              ...
              style={{ color: "white", margin:"0 10px" }}
            />
            {language==="en"?`Siraj Al Islam manages One 2 One Legal, the firm awarded Best
            Boutique Law Firm in Saudi Arabia`:`سراج الإسلام يديرشركة ون تو ون للمحاماة ، الشركة التي
